...
#include "sched.h"
// Cada processo na loteria ira receber um intervalo do tamanho de sua quantidade de ticketes
// Um numero aleatorio sera gerado e, caso pertenca ao intervalo, o processo ganhara cpu
